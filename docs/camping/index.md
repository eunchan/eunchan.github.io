...
차박 캠핑을 하려고 산 제품입니다. 바람이 많이 부는 날에는 텐트를 설치하면 바람에
펄럭이는 소리에 잠을 잘 못자는데, 그 때 그냥 텐트 접고 트럭 (F-150) 뒷 자리에서
잠을 잔 적이 있었습니다. 다리를 살짝 접어야 하는 불편함은 있지만, 텐트에서 자는
것 보다는 훨씬 편하게 잘 수 있더라구요.

그래서 뒷자리에 매트를 깔 수는 없을까 하고 찾아보고 발견한 게 이 제품입니다.
다른 매트는 약간 기울어진 뒷자리를 편평하게 하지 못하는데, 이 제품은 높낮이에
맞게 매트가 부풀어 올라서 편평한 침대를 만들어줍니다. 게다가 뒷자리 팔 거치대와
높이가 맞아서 조금 더 길게 다리를 뻗을 수 있습니다. 대각선으로 누우면 더
편해지고요.
